...
| 6 | The sketchbook rebuild | ADR 0008. Ink library, paper as a surface, controls in the same hand, the page turn, deep links. The architecture stays; the visual layer is rebuilt. Night landed separately as 19. |

...
| 31 | An occupancy surface for the atlas claim | `atlas-no-net-change` is the first finding with a view and no layer: the camera flies to southern Africa and nothing is drawn, because no Δψ surface has been exported. Needs a per-cell export through the ethics gate — species declining and increasing per quarter-degree cell — and a manifest entry. |
